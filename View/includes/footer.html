  ...
  <div class="container-fluid">
    <div class="row footer_1">
      <div class="col-md-3">
        <div class="footer_1i">
          ...
          <p>Phasellus and the message of the snow. Even the analysis of the faucet's crime. Always take up the great,
            and the unbroken lake is always life. But the handle is not only to be placed to obtain the pure mauris.</p>
        </div>
      </div>
      <div class="col-md-3">
        <div class="footer_1i">
    ...
    <div class="row footer_2 mt-4 text-center">
      <div class="col-md-12">
        ...
        <p class="mb-0">© 2025 Your Website Name. All Rights Reserved | Design by <a class="col_pink"
